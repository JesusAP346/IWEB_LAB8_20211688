...
public class PeliculaServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        switch (action) {
            ...
            case "borrar":
                String idPeliculaDelete = request.getParameter("idPelicula");
                pelicula peliculaDelete = peliculaDao.buscarPorId(idPeliculaDelete);

                if(peliculaDelete != null){
                    try {
                        peliculaDao.borrarPelicula(idPeliculaDelete);
